import { AccessDeniedError } from "@easygardenplan/authz";
import { BillingAlreadyCancelled, BillingConfigurationError, BillingPlanUnavailable, BillingProviderUnavailable, BillingRateLimited, BillingSubscriptionNotFound, BillingValidationError } from "@easygardenplan/integrations";
...
export function mapHttpError(error: unknown): HttpError {
  // The status follows the decision; the body never names the missing permission or entitlement.
