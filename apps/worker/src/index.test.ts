...
vi.mock("@easygardenplan/db", async (importOriginal) => ({
  ...await importOriginal<typeof import("@easygardenplan/db")>(),
...
import { eventEnvelopeSchema } from "@easygardenplan/events";
