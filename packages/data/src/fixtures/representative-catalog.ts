...
const payloads: Record<RuleType, RulePayload> = {
  ...
  climate_response: { state: "known", type: "climate_response", hazard: "cold", stage: "seedling", thresholdCelsius: { minimum: 0, maximum: 5, minimumInclusive: true, maximumInclusive: true }, clearAboveCelsius: 6, resolutionConfirmations: 2, deliveryClass: "urgent", action: "Synthetic fixture action" },
