...
const climateResponseSchema = z.object({ state: z.literal("known"), type: z.literal("climate_response"), hazard: z.enum(["cold", "heat"]), stage: z.string().min(1), thresholdCelsius: rangeSchema, action: z.string().min(1).max(2000) }).strict();
