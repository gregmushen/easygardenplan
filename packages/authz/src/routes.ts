...
export const customerRoutePolicies = defineRoutePolicies(permissions, [
  ...
  { method: "GET", path: "/api/catalog", audience: "tenant", permission: "garden.read" },
  { method: "GET", path: "/api/editorial/rules", audience: "tenant", permission: "catalog.publish" },
  { method: "POST", path: "/api/editorial/research", audience: "tenant", permission: "catalog.publish" },
  { method: "POST", path: "/api/editorial/drafts", audience: "tenant", permission: "catalog.publish" },
  { method: "POST", path: "/api/editorial/rules/:id/review", audience: "tenant", permission: "catalog.publish" },
  { method: "POST", path: "/api/editorial/releases", audience: "tenant", permission: "catalog.publish" },
  { method: "POST", path: "/api/editorial/rules/:id/withdraw", audience: "tenant", permission: "catalog.publish" },
  { method: "POST", path: "/api/editorial/coverage", audience: "tenant", permission: "catalog.publish" },
  { method: "POST", path: "/api/location/geocode", audience: "tenant", permission: "garden.write" },
  { method: "PUT", path: "/api/gardens/:id/location", audience: "tenant", permission: "garden.write" },
  ...
  { method: "GET", path: "/api/gardens/:id/selections", audience: "tenant", permission: "garden.read" },
  { method: "POST", path: "/api/gardens/:id/selections", audience: "tenant", permission: "garden.write" },
  { method: "PUT", path: "/api/gardens/:id/selections/:selectionId", audience: "tenant", permission: "garden.write" },
  { method: "DELETE", path: "/api/gardens/:id/selections/:selectionId", audience: "tenant", permission: "garden.write" },
  { method: "GET", path: "/api/gardens/:id/plans", audience: "tenant", permission: "garden.read" },
  { method: "POST", path: "/api/gardens/:id/plans", audience: "tenant", permission: "garden.write" },
  { method: "POST", path: "/api/gardens/:id/plans/:planId/adjust", audience: "tenant", permission: "garden.write" },
  { method: "POST", path: "/api/gardens/:id/plans/:planId/activate", audience: "tenant", permission: "garden.write" },
  { method: "GET", path: "/api/gardens/:id/plans/:planId/print.svg", audience: "tenant", permission: "garden.read" },
  { method: "GET", path: "/api/gardens/:id/tasks", audience: "tenant", permission: "garden.read" },
  { method: "POST", path: "/api/gardens/:id/tasks/:taskId/transition", audience: "tenant", permission: "garden.write" },
  { method: "GET", path: "/api/gardens/:id/progress", audience: "tenant", permission: "garden.read" },
  { method: "POST", path: "/api/gardens/:id/progress", audience: "tenant", permission: "garden.write" },
  { method: "GET", path: "/api/gardens/:gardenId/monitoring", audience: "tenant", permission: "garden.read" },
  { method: "POST", path: "/api/gardens/:gardenId/monitoring/evaluations", audience: "tenant", permission: "garden.write", entitlement: "weather.monitoring" },
  { method: "GET", path: "/api/notifications/preferences", audience: "tenant", permission: "garden.read" },
  { method: "PUT", path: "/api/notifications/preferences", audience: "tenant", permission: "garden.write" },
]);
